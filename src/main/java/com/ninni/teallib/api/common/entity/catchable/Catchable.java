...
/**
 * Allows a Mob to be captured into an ItemStack and released later.
 * <p>
 * Implementations can customize whether they may be caught, the
 * ItemStack they become, the data stored while captured and the
 * sounds played during pickup and release.
 * <p>
 * basically like {@link net.minecraft.world.entity.animal.Bucketable Bucketable} but good
 */
public interface Catchable {
    ...
    /**
     * @param capturingItem A single-item copy of the capturing ItemStack.
     * @return the message displayed when the mob cannot be captured,
     * or {@code null} to display nothing.
     */
    @Nullable
    ...
    /**
     * Saves additional mob data when the mob is captured.
     * <p>
     * The default implementation saves common entity properties.
     *
    ...
    /**
     * Restores mob data after the mob is released.
     * <p>
     * The default implementation restores common entity properties.
     *
     * @param mob The released Mob.
     * @param tag The saved Compound Tag.
     */
    ...
    /**
     * Attempts to capture a Catchable mob using an ItemStack.
     * <p>
     * The mob's data is written to the resulting ItemStack before the
     * entity is removed from the world.
     *
     * @param player The Player attempting the capture.
     * @param hand The Interaction Hand used.
     * @param mob The Catchable Mob.
     * @param extraData Additional data to merge into the saved tag.
     * @return the interaction result, if the interaction was handled.
     */
    ...
    /**
     * Recreates a previously captured mob from its saved data.
     * <p>
     * If no valid entity type is stored, the supplied fallback type
     * is spawned instead.
     *
     * @param tag The saved entity data.
     * @param level The Server Level.
     * @param vec The spawn position.
     * @param yRot The entity's yaw.
     * @param xRot The entity's pitch.
     * @param fallbackType The Entity Type used if none could be restored.
     * @return the spawned Mob, or {@code null} if spawning failed.
     */

...
/**
 * A class that implements the basics of a {@link com.ninni.teallib.api.common.data.entityvariant.EntityVariantManager.EntityVariantData Entity Variant Data} system extending {@link AbstractFish AbstractFish}
 */
public abstract class AbstractVariantFish extends AbstractFish implements JsonVariantHolder {
    private static final EntityDataAccessor<String> DATA_VARIANT = SynchedEntityData.defineId(AbstractVariantFish.class, EntityDataSerializers.STRING);

    public AbstractVariantFish(EntityType<? extends AbstractFish> entityType, Level level) {

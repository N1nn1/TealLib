...
/**
 * A class that implements the basics of a {@link com.ninni.teallib.api.common.data.entityvariant.EntityVariantManager.EntityVariantData Entity Variant Data} system extending {@link AgeableMob AgeableMob}
 */
public abstract class AbstractVariantAgeableMob extends AgeableMob implements JsonVariantHolder {
    private static final EntityDataAccessor<String> DATA_VARIANT = SynchedEntityData.defineId(AbstractVariantAgeableMob.class, EntityDataSerializers.STRING);

    public AbstractVariantAgeableMob(EntityType<? extends AgeableMob> entityType, Level level) {

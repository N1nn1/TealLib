...
/**
 * A class that implements the basics of a {@link com.ninni.teallib.api.common.data.entityvariant.EntityVariantManager.EntityVariantData Entity Variant Data} system extending {@link PathfinderMob PathfinderMob}
 */
public abstract class AbstractVariantPathfinderMob extends PathfinderMob implements JsonVariantHolder {
    private static final EntityDataAccessor<String> DATA_VARIANT = SynchedEntityData.defineId(AbstractVariantPathfinderMob.class, EntityDataSerializers.STRING);

    public AbstractVariantPathfinderMob(EntityType<? extends PathfinderMob> entityType, Level level) {
    ...
    public @Nullable SpawnGroupData finalizeSpawn(@NotNull ServerLevelAccessor serverLevelAccessor, @NotNull DifficultyInstance difficultyInstance, @NotNull MobSpawnType mobSpawnType, @Nullable SpawnGroupData spawnGroupData) {
        if (mobSpawnType != MobSpawnType.BUCKET) {
            EntityVariantManager.getNaturallyOccurringVariant(this, serverLevelAccessor);
        }

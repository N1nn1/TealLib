...
import com.ninni.teallib.api.common.entity.variant.base.AbstractVariantFish;
...
public abstract class AnimatedVariantFish extends AbstractVariantFish implements EntityAnimationHolder {
    private static final EntityDataAccessor<CompoundTag> ANIMATION_SYNC = SynchedEntityData.defineId(AnimatedVariantFish.class, EntityDataSerializers.COMPOUND_TAG);
    protected final EntityAnimationController animations = new EntityAnimationController(this);

    protected AnimatedVariantFish(EntityType<? extends AbstractVariantFish> entityType, Level level) {

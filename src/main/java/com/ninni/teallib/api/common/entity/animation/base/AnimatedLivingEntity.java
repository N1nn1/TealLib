...
/**
 * A class that implements the basics of an {@link EntityAnimationController EntityAnimationController} system extending {@link LivingEntity LivingEntity}
 */
public abstract class AnimatedLivingEntity extends LivingEntity implements EntityAnimationHolder {
    private static final EntityDataAccessor<CompoundTag> ANIMATION_SYNC = SynchedEntityData.defineId(AnimatedLivingEntity.class, EntityDataSerializers.COMPOUND_TAG);
    protected final EntityAnimationController animations = new EntityAnimationController(this);

    protected AnimatedLivingEntity(EntityType<? extends LivingEntity> entityType, Level level) {

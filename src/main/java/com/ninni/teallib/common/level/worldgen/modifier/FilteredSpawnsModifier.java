package com.ninni.teallib.common.level.worldgen.modifier;
...
public record FilteredSpawnsModifier(HolderSet<Biome> biomes, HolderSet<Biome> filtered, List<MobSpawnSettings.SpawnerData> spawners) implements BiomeModifier {
